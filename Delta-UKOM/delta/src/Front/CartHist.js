...
function CartHist() {
    ...
    const [cart] = UseGet(`/cartHist/${idpelanggansession}`);
  ...
  return (
    <div>
      ...
      <div className="w-screen h-screen flex text-sm">
        {cart.length === 0 && (
          <div className="w-2/3 h-screen bg-herowhite flex-col justify-center items-center">
            ...
            <div className="  w-full flex justify-center items-center mx-auto ">
              ...
              <h1 className="font-HSR text-xl underline hover:no-underline">
                <a href="/cart">Lihat Keranjang Sekarang</a>{" "}
              </h1>
            </div>
          </div>
        )}
                    ...
                    <div className="  flex justify-between items-center ">
                      ...
                      <div className="p-5 flex justify-end ">
                        ...
                        <button
                          ...
                          className="inline-flex cursor-not-allowed py-2  items-center px-5  text-lg font-medium text-center bg-floralwhite text-deepkoamaru hover:bg-deepkoamaru hover:text-floralwhite hover:border-floralwhite border-2 transition duration-300 ease-linear rounded-lg "
                        >
                          Sedang Dikirim!
                        </button>
                      </div>
          ...
          <div className=" h-screen flex flex-col justify-center items-center">
            <div className="w-full flex items-center justify-around">
              <h1 className="font-normal font-HSR  text-white text-md">
                Saldo anda: Rp. <b className="text-2xl">{currentSaldo}</b>
              </h1>
              <button
                onClick={() => {
                  modalTopup();
